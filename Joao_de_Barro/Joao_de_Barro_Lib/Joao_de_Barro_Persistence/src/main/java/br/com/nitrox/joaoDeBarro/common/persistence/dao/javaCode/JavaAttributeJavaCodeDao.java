...
import br.com.nitrox.joaoDeBarro.common.persistence.dao.javaCode.javaAttributes.DataStagingHpdAuditLogSystemJavaAttributeJavaCode;
	...
	public JavaAttribute[] getJavaAttributes( String entityName ) {
		...
		if ( entityName != null ) {
			if ( entityName.equalsIgnoreCase( "Data_Staging_Hpd_Help_Desk" )) {
				...
				javaAttributeUnit = 
						new DataStagingHpdAuditLogSystemJavaAttributeJavaCode();
			}
