...
public class AnsiSql99DaoDeleteMethodGenerator extends AbstractJavaEntityGenerator {
	
	public AnsiSql99DaoDeleteMethodGenerator( JavaEntity javaEntity ) {
		super( javaEntity );
	}
	
	
	public int getTemplateCode() {
		return TEMPLATE_DAO_ANSISQL99_DELETE_METHOD;
	}
