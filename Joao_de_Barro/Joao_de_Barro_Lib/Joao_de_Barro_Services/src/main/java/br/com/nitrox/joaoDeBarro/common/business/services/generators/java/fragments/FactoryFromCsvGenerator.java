...
public class FactoryFromCsvGenerator extends AbstractJavaEntityGenerator {
	
	public FactoryFromCsvGenerator( JavaEntity javaEntity ) {
		super( javaEntity );
	}
	
	
	public int getTemplateCode() {
		return TEMPLATE_FACTORY_FROM_CSV;
	}
