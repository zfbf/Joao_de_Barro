...
public class CreateWorkspaceDirectoriesAntfile extends AbstractStaticJoaoDeBarroLogger {
	private static final String CLASS_NAME = "CreateWorkspaceDirectoriesAntfile";
	...
	public static void main( String[] args ) {
		...
		try {
			...
			String version = CreateWorkspaceDirectoriesAntfile.class.getPackage().
